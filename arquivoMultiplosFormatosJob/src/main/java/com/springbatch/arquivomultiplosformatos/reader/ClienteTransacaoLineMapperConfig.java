...
public class ClienteTransacaoLineMapperConfig {
    ...
    public PatternMatchingCompositeLineMapper lineMapper() {
        ...
        lineMapper.setFieldSetMappers(getStringFieldSetMapperMap());//mapeia as palavras para um objeto de dominio
        return lineMapper;
    }
    ...
    private Map<String, FieldSetMapper> getStringFieldSetMapperMap() {
        ...
        fieldSetMappers.put("0*", getFieldSetMapper(Cliente.class));
        fieldSetMappers.put("1*", getFieldSetMapper(Transacao.class));
        return fieldSetMappers;
    }

    private static FieldSetMapper getFieldSetMapper(Class classe) {
